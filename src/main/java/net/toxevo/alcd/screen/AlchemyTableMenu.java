package net.toxevo.alcd.screen;
...
import net.toxevo.alcd.screen.slot.ModResultSlot;
...
public class AlchemyTableMenu extends AbstractContainerMenu {
    ...
    public AlchemyTableMenu(int pContainerId, Inventory inv, BlockEntity entity) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ALCHEMY_TABLE_BLOCK.get());
    }
